          ...
          return (
            ...
            return (
                <div className='text-box'>
                    ...
                    <p>Je suis quelqu'un qui avance sans prétention mais avec exigence : de l'exigence envers moi-même, envers le code que je construis, envers l'impact que je veux avoir. Mon ambition ? Élaborer des systèmes élégants, performants et discrets, au service de causes qui m'animent, telles que l'environnement, l'éducation ou la santé.</p>
                </div>
            )
            ...
            return (
              <>
                ...
                <div className="block">
                  ...
                  <p className="details">
                    Taught students aged 12 to 15 (equivalent to grades 7–9).  
                    Served twice as homeroom teacher for 9th grade.  
                    Led various support initiatives to struggling students.
                  </p>
                </div>
                <div className="block">
                  ...
                  <p className="details">
                    Taught students aged 11 to 15 (grades 6–9).  
                    Served four times as homeroom teacher for 9th grade.  
                    Provided support to struggling students and ran a trading card game club (Magic: The Gathering).
                  </p>
                </div>
                <div className="block">
                ...
                <div className="block">
                  ...
                  <p className="place">Le Verney Secondary School<br />Sallanches (France)</p>
                  <p className="details">
                    Taught two sections of 6th grade and two of 7th grade (students aged 11–12).
                  </p>
                </div>
              </>
            );
            ...
            return (
                <div className='text-box'>
                  <p>After teaching mathematics for twelve years — a mission I deeply cared about — I made a bold career change through a mutually agreed transition into the field of software development. I love learning, evolving, stepping outside my comfort zone: this new path truly fulfills me.</p>
                  <p>My previous career equipped me with valuable soft skills: pedagogy, patience, organization, communication... Naturally persistent, I find genuine joy in learning to code — especially because it brings back what I’ve always loved about math: rigor, pure logic, and the elegance of well-crafted solutions. Teaching also taught me to be both autonomous and collaborative — two essential traits in a world where teamwork matters and self-sufficiency is priceless.</p>
                  <p>I value effort: whether it's progressing in trail running, mountain biking, Norwegian, TypeScript, or Rust, I enjoy going deep and pushing myself. I don’t settle for the basics — I explore, deconstruct, and strive to understand rather than memorize. It’s the same philosophy I always aimed to pass on to my students. In that spirit, I tend to favor writing clear, explicit vanilla code over piling up libraries and frameworks that might blur simplicity and readability. This drive for clarity also shapes the tools I enjoy using or designing: minimalism, sobriety, and smoothness are core principles for me.</p>
                  <p>I move forward without pretension, but with high standards — for myself, for the code I write, and for the impact I aim to have. My ambition? To build elegant, efficient, discreet systems that serve causes I care about, such as the environment, education, or public health.</p>
                </div>
            )
