          ...
          return (
            ...
            return (
                <div className='text-box'>
                    ...
                    <p>Je suis quelqu'un qui avance sans prétention mais avec exigence : de l'exigence envers moi-même, envers le code que je construis, envers l'impact que je veux avoir. Mon ambition ? Élaborer des systèmes élégants, performants, discrets, et surtout porteurs de sens.</p>
                </div>
            )
            ...
            return (
                <div className='text-box'>
                  ...
                  <p>I move forward without pretension, but with high standards — for myself, for the code I write, and for the impact I aim to have. My ambition? To build elegant, efficient, discreet, and above all meaningful systems.</p>
                </div>
            )
