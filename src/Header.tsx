    ...
    return (
        <header>
            ...
            <div className='box short'>
                {lang === 'fr' && "Développeur full-stack, j'effectue actuellement un stage en milieu professionnel. Fort de douze années d'expérience comme professeur de mathématiques, j'ai gardé une nature rigoureuse et persévérante. Aujourd'hui, mon choix technique s'est porté sur Next.js pour sa vision d’ensemble, décloisonnée et moderne. Par curiosité, j’explore aussi Rust pour élargir ma culture technologique."}
                {lang === 'en' && "As a full-stack developer, I'm currently undertaking an internship. With twelve years of experience as a mathematics teacher, I have kept a rigorous and persistent mindset. Today, I have chosen Next.js for its comprehensive, modern, and uncloistered approach. Out of curiosity, I also explore Rust to broaden my technological horizon."}
                {lang === 'nb' && "Som fullstack-utvikler jobber jeg for tiden som praktikant. Med tolv års erfaring som matematikklærer har jeg beholdt en natur preget av nøyaktighet og utholdenhet. I dag har jeg valgt Next.js for dets helhetlige, moderne og åpne tilnærming. Av nysgjerrighet utforsker jeg også Rust for å utvide mitt teknologiske perspektiv."}
            </div>
